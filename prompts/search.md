TASK:
- use the community-evals skill. 
- get the top 50 trending models. 
- review which ones have eval results using the api based on the community-evals skill. 
...
OUTPUT FORMAT:
- a correctly formatted table of proposed PRs to model repos on Hugging Face based on the community-evals skill.